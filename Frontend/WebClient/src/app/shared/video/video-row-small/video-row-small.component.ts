...
@Component({
  selector: 'app-video-row-small',
  templateUrl: './video-row-small.component.html',
  styleUrls: ['./video-row-small.component.css'],
})
export class VideoRowSmallComponent implements OnInit {
  @Input()
  video?: Video;
