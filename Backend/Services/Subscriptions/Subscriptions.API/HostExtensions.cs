...
using Subscriptions.API.Application.AutoMapperProfiles;
    ...
    public static class HostExtensions {
        ...
        public static async Task InitializeAsync (this WebApplication app) {
            ...
            if (config.GetValue<bool>("MigrateDatabase")) {
                await app.MigrateDatabase<SubscriptionsDbContext>();
            }
        }
        ...
        private static WebApplicationBuilder AddConfigurations (this WebApplicationBuilder builder) {
            ...
            builder.Services
                .Configure<NotificationConfiguration>(configuration.GetSection("NotificationConfiguration"))
        ...
        private static WebApplicationBuilder AddOpenTelemetry (this WebApplicationBuilder builder) {
            ...
            builder.Services.AddOpenTelemetry()
                .ConfigureResource(options => {
                    options.AddService("Subscriptions");
                })
                .WithTracing(options => {
        ...
        private static WebApplicationBuilder AddDbContext (this WebApplicationBuilder builder) {
            ...
            builder.Services.AddDbContext<SubscriptionsDbContext>(ctx => {
            ...
            builder.Services.AddHealthChecks().AddDbContextCheck<SubscriptionsDbContext>();
        ...
        private static WebApplicationBuilder AddServices (this WebApplicationBuilder builder) {
            builder.Services
                .AddScoped<INotificationDataAccess, NotificationDataAccess>()
                .AddScoped<ISubscriptionQueryManager, SubscriptionQueryManager>()
        ...
        private static WebApplicationBuilder AddRepositories (this WebApplicationBuilder builder) {
            builder.Services
                ...
                .AddDomainEventsAccessor<DomainEventsAccessor<SubscriptionsDbContext>>()
                .AddUnitOfWork<UnitOfWork<SubscriptionsDbContext>>();

            return builder;
        }

        private static WebApplicationBuilder AddIdempotencyContext (this WebApplicationBuilder builder) {
            builder.Services.AddIdempotencyContext<SubscriptionsDbContext>();

            return builder;
        }

        private static WebApplicationBuilder AddTransactionalEvents (this WebApplicationBuilder builder) {
            builder.Services.AddTransactionalEventsContext<TransactionalEventsContext<SubscriptionsDbContext>>(options => {
                options.UseNpgsql();
            });

            builder.Services.AddTransactionalEventsProcessingService()
               .UseEntityFrameworkCore<SubscriptionsDbContext>()
