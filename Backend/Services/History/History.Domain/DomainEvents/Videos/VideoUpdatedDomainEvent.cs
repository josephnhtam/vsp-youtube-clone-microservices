...
namespace History.Domain.DomainEvents.Videos {
    public class VideoUpdatedDomainEvent : IDomainEvent {
        ...
        public VideoUpdatedDomainEvent (Guid videoId, string title, string description, string tags, string? thumbnailUrl, string? prewviewThumbailUrl, int? lengthSeconds, VideoVisibility visibility, VideoStatus status, DateTimeOffset? publishDate, long version) {
            VideoId = videoId;
            Title = title;
