    ...
    public static class HostExtensions {
        ...
        public static async Task InitializeAsync (this WebApplication app) {
            ...
            if (config.GetValue<bool>("MigrateDatabase")) {
                await app.MigrateDatabase<VideoManagerDbContext>();
            }
        }
        ...
        private static WebApplicationBuilder AddConfigurations (this WebApplicationBuilder builder) {
            ...
            builder.Services
                .Configure<VideoUploadConfiguration>(configuration.GetSection("VideoUploadConfiguration"))
        ...
        private static WebApplicationBuilder AddOpenTelemetry (this WebApplicationBuilder builder) {
            ...
            builder.Services.AddOpenTelemetry()
                .ConfigureResource(options => {
                    options.AddService("VideoManager");
                })
                .WithTracing(options => {
                    options.AddSource("Mediator", "IntegrationEvent", "VideoManager")
        ...
        private static WebApplicationBuilder AddDbContext (this WebApplicationBuilder builder) {
            ...
            builder.Services.AddDbContext<VideoManagerDbContext>(ctx => {
            ...
            builder.Services.AddHealthChecks().AddDbContextCheck<VideoManagerDbContext>();
        ...
        private static WebApplicationBuilder AddRepository (this WebApplicationBuilder builder) {
            builder.Services
                ...
                .AddDomainEventsAccessor<DomainEventsAccessor<VideoManagerDbContext>>()
                .AddUnitOfWork<UnitOfWork<VideoManagerDbContext>>();

            return builder;
        }

        private static WebApplicationBuilder AddIdempotencyContext (this WebApplicationBuilder builder) {
            builder.Services.AddIdempotencyContext<VideoManagerDbContext>();

            return builder;
        }

        private static WebApplicationBuilder AddTransactionalEvents (this WebApplicationBuilder builder) {
            builder.Services.AddTransactionalEventsContext<TransactionalEventsContext<VideoManagerDbContext>>(options => {
                options.UseNpgsql();
            });

            builder.Services.AddTransactionalEventsProcessingService()
               .UseEntityFrameworkCore<VideoManagerDbContext>()
